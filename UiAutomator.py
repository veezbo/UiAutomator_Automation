...
#Read in Arguments
parser = argparse.ArgumentParser(description="Description: \n\tBuild and run one or multiple UiAutomator projects at once", epilog="********Example Usages*********\n\n ./UiAutomator -p /home/vibhor/workspace/Create_Contacts/ -c contacts.create_contacts\n\n ./UiAutomator -p /home/vibhor/workspace/Create_Contacts/ /home/vibhor/workspace/Contacts_Verification/ -c contacts.create_contacts contacts_verification", formatter_class=RawTextHelpFormatter)
...
#Ensure package names end with a '/'
def endSlash(p):
	if p[-1] == '/':
		return p
	else:
		return p+'/'
args.p = map(endSlash, args.p)


#Get Name from project paths
def getName(p):
	return p.split('/')[-2]
